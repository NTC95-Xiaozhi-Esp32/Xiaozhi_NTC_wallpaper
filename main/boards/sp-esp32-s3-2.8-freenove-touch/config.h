...
// Some ESP-IDF/codec stacks expose ES8311 default address via esp_codec_dev_defaults.h.
// Provide a safe fallback to avoid build breakage when the macro is unavailable.
...
#define DISPLAY_MISO_PIN      DISPLAY_MIS0_PIN
